...
strategy = Strategy(push_client=push_client, trade_client=trade_client, quote_client=quote_client,
...
if __name__ == '__main__':
    ...
    try:
        if event_trigger:
            ...
            curr_time = (datetime.now().astimezone(curr_timezone).replace(second=SYSTEM_DELAY,
                                                                          microsecond=0) + one_minute).time()
