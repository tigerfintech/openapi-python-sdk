...
from tigeropen.examples.tinyquant import settings
...
def get_client_config():
    ...
    :return:
    """
    client_config = TigerOpenClientConfig(sandbox_debug=settings.IS_SANDBOX)
    client_config.private_key = read_private_key(settings.PRIVATE_KEY)
