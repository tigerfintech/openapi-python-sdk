...
class AssetData(_message.Message):
    __slots__ = ["account", "availableFunds", "buyingPower", "cashBalance", "currency", "equityWithLoan", "excessLiquidity", "grossPositionValue", "initMarginReq", "maintMarginReq", "netLiquidation", "segType", "timestamp"]
