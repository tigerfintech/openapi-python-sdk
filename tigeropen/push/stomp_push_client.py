...
class StompPushClient(stomp.ConnectionListener):
    ...
    def subscribe_quote(self, symbols, quote_key_type=QuoteKeyType.TRADE, focus_keys=None, **kwargs):
        """
        订阅行情更新
        :param symbols:
    ...
    def subscribe_tick(self, symbols, *args, **kwargs):
        """
    ...
    def subscribe_depth_quote(self, symbols, *args, **kwargs):
        """
        订阅深度行情
        :param symbols: symbol列表
        :return:
